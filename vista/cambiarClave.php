        ...
        <form action="" method="POST">
         ...
         while ($datos=$sql->fetch_object()) { ?>
            ...
            <div class="fl-flex-label mb-4 px-2 col-12">
                <input type="password" placeholder="Contraseña actual" class="input input__text" name="txtclaveactual"
                    value="">
            </div>
            <div class="fl-flex-label mb-4 px-2 col-12">
                <input type="password" placeholder="Contraseña nueva" class="input input__text" name="txtclavenueva"
                    value="">
            </div>
