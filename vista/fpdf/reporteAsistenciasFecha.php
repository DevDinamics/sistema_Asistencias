...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('logo.png', 250, 1, 45); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      $this->SetFont('Arial', 'B', 19); //tipo fuente, negrita(B-I-U-BIU), tamañoTexto
      $this->Cell(45); // Movernos a la derecha
      $this->SetTextColor(0, 0, 0); //color
      //creamos una celda o fila
      $this->Cell(180, 15, utf8_decode($dato_info->nombre), 0, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
      ...
      $this->Cell(35, 10, utf8_decode('TOTAL HRS'), 1, 1, 'C', 1);
...
$pdf->Cell(35, 10, utf8_decode($datos_reporte->totalHR), 1, 1, 'C', 0);

   }



$pdf->Output('reporteAsistencias.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
