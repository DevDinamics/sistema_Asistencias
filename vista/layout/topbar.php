...
<head>
    ...
    <head lang="es">
        ...
        <script src="https://kit.fontawesome.com/4fda24b58c.js" crossorigin="anonymous"></script>
                        ...
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown user-menu">
                                <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="../public/app/publico/img/user.png" alt="">
                                </button>
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <a class="dropdown-item" href="../controlador/controlador_cerrar_session.php">
