            ...
            <ul class="side-menu-list p-0">
                <li class="red">
                    <a href="inicio.php" class="activo">
                        <img src="../public/img-inicio/asistencias.png" class="img-inicio" alt="">
                ...
                <li class="red">
                    <a href="usuario.php" class="activo">
                        <img src="../public/img-inicio/usuario.png" class="img-inicio" alt="">
                        <!-- <i class="fas fa-house-user"></i> -->
                ...
                <li class="red">
                    <a href="empleado.php" class="activo">
                        <img src="../public/img-inicio/empleado.png" class="img-inicio" alt="">
                        <!-- <i class="fas fa-house-user"></i> -->
                ...
                <li class="red">
                    <a href="acerca.php" class="activo">
                        <img src="../public/img-inicio/inf.png" class="img-inicio" alt="">
